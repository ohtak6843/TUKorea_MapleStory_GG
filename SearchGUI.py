...
class SearchGUI:
    ...
    def characterInfoSearch(self):
        # 직업 리벨
        self.nameLabel = Label(self.window, text=str(self.mapleInfo.basic["character_class"]), bg='#9aa2ab', width=15)
        self.nameLabel.place(x=40, y=43)
        ...
        # 무릉도장
        self.Mu_Lung_Dojo = Label(self.window, text="", bg='#c9ced0', width=5)
        self.Mu_Lung_Dojo.place(x=115, y=158)

        # 인기도
        self.unionLabel = Label(self.window, text="", bg='#c9ced0', width=5)
        self.unionLabel.place(x=115, y=183)


        # 길드
        self.guild = Label(self.window, text="", bg='#c9ced0', width=10)
        self.guild.place(x=493  , y=159)

        # 연맹
        self.Federation = Label(self.window, text="", bg='#c9ced0', width=10)
        self.Federation.place(x=493, y=183)
